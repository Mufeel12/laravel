...
$router->group(['middleware' => 'web', 'prefix' => 'spark'], function ($router) {
    ...
    $router->get('/api/settings/invoices', 'Settings\Billing\InvoiceController@all');
...
// Webhooks...
$router->post('/paystickapi', 'Auth\RegisterController@payStickRegister');
