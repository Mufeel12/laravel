            ...
            <table width="540px" border="0" cellspacing="0" cellpadding=""
                ...
                <tr>
                    <td>
                        ...
                        <p class='email-lines'>Issues with your account has been resolved and your account has been restored.</p>
                        <p class='email-lines'>You should be able to login normally into your account now.</p>
                        <p class='email-lines'>However note that you need to re-activate your account to get your videos playing again.</p>
                        <p class='email-lines'>Go to your Billing & Subscriptions center in your settings to re-activate the account.</p>

                        <div style='width: 100%; position: relative; margin: 30px 0; text-align: center;'>
                            <a href="{{ config('env.ROOT_URL') }}" class="sign-in-btn">
