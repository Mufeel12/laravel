...
<div id="collapseContent" class="panel-collapse collapse grey-dashed" role="panel" aria-labelledby="Content">
    <div class="row-space-top-3 clearfix">
        <div style="padding: 0 10px;">
            ...
            {{-- Sub headline --}}
            <div class="clearfix row-space-3">
                <label for="subHeadline" class="editor-label">Description</label>
                <textarea v-model="data.subtitle" class="form-control" rows="5" placeholder="Your video description goes here"></textarea>
            </div>
